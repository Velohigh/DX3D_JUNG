...
PxRigidDynamic* PhysXMgr::CreateDynamic(const PxTransform& t, const PxGeometry& geometry, CGameObject* _Object, const PxVec3& velocity)
{
    if (nullptr == _Object)
        assert(nullptr);
...
PxRigidStatic* PhysXMgr::CreatePlane(Vec4 _Plane)
{
